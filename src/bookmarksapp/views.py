...
def bookmark_list(request):
    ...
    return render(request, 'bookmarksapp/bookmark_list.html', context)
...
def bookmark_user(request, username):
    ...
    return render(request, 'bookmarksapp/bookmark_user.html', context)
...
def bookmark_create(request):
    ...
    return render(request, 'bookmarksapp/forms.html', context)
...
def bookmark_edit(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('bookmarksapp_bookmark_user',
                username=request.user.username)
    else:
        form = BookmarkForm(instance=bookmark)
    context = {'form': form, 'create': False}
    return render(request, 'bookmarksapp/form.html', context)
